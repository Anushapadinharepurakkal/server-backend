...
class IrActionsServer(models.Model):
    ...
    def run(self):
        ...
        * Natively, actions without explicit groups crash if the user lacks 'write' access.
        ...
        * `super().run()` reads the cache, bypassing the hardcoded 'write' check natively.
        ...
        if role_group_ids:
            ...
            for action in self.sudo():
                if not action.groups_id:
                    ...
                    self.env.cache.set(action, action._fields['groups_id'], role_groups_tuple)
