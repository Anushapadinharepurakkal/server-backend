...
class RoleModelAccess(models.Model):
    ...
    role_id = fields.Many2one(
        "res.users.role", string="Role", required=True, ondelete="cascade"
    )
        ...
        for record in self:
            ...
            if existing:
                ...
                raise ValidationError(
                    _(
                        'The model "%s" is already configured for this Role.'
                        "\n\nPlease edit the existing Model Access entry instead "
