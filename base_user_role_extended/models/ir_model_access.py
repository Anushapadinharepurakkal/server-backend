...
class IrModelAccess(models.Model):
    ...
    def _get_role_model_permission_map(self, uid):
        ...
        for record in role_access_records:
            ...
            permission_map[model_name]["write"] = (
                permission_map[model_name]["write"] or record.perm_write
            )
            permission_map[model_name]["create"] = (
                permission_map[model_name]["create"] or record.perm_create
            )
            permission_map[model_name]["unlink"] = (
                permission_map[model_name]["unlink"] or record.perm_unlink
            )
